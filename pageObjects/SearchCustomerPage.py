...
class SearchCustomer:
    ...
    def setFirstName(self, fname):
        ...
        self.driver.find_element(By.XPATH, self.txtFirstName_id).send_keys(fname)

    def setLastName(self, lname):
        self.driver.find_element(By.XPATH, self.txtLastName_id).clear()
        self.driver.find_element(By.XPATH, self.txtLastName_id).send_keys(lname)
    ...
    def searchCustomerByEmail(self,email):
        ...
        for r in range(1,self.getNoOfRows()+1):
            ...
            emailid = table.self.driver.find_elements(By.XPATH, "//table[@id='customers-grid']/tbody/tr["+str(r)+"]/td[2]").text
            if emailid == email:
                flag = True
                break
        return flag
    ...
    def searchCustomerByName(self,Name):
        ...
        for r in range(1,self.getNoOfRows()+1):
            table = self.driver.find_elements(By.XPATH, self.table_xpath)
            name = table.self.driver.find_elements(By.XPATH, "//table[@id='customers-grid']/tbody/tr["+str(r)+"]/td[3]").text
            if name == Name:
                flag = True
                break
        return flag
